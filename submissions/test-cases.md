...
| TC-03-01     | Kiểm tra tìm kiếm theo tên sách bằng chữ thường                | Người dùng hoặc admin đã đăng nhập và ở mục danh sách sách       | Nhập từ khóa "lập trình" vào ô Tìm kiếm theo tên sách hoặc tác giả                                 | Từ khóa: "lập trình"                                     | Hệ thống hiện các tựa sách "Lập trình Flutter cơ bản" và "Nhập môn lập trình Python"                                            | REQ-03 | EP                |
| TC-03-02     | Kiểm tra tìm kiếm theo tên tác giả bằng chữ thường             | Người dùng hoặc admin đã đăng nhập và ở mục danh sách sách       | Nhập từ khóa "vũ thị mai" vào ô Tìm kiếm theo tên sách hoặc tác giả                                | Từ khóa: "vũ thị mai"                                    | Hệ thống hiện các tựa sách "Nguyên lý kế toán" với tác giả "Vũ Thị Mai"                                                         | REQ-03 | EP                |
| TC-03-03     | Kiểm tra tìm kiếm trong ô Lọc theo thể loại bằng chữ thường    | Người dùng hoặc admin đã đăng nhập và ở mục danh sách sách       | Nhập từ khóa "công nghệ " vào ô Lọc theo thể loại                                                  | Từ khóa: "công nghệ"                                     | Hệ thống hiện các tựa sách thuộc thể loại Công nghệ                                                                             | REQ-03 | EP                |
| TC-03-04     | Kiểm tra tìm kiếm trong ô Lọc theo thể loại mà có chữ viết hoa | Người dùng hoặc admin đã đăng nhập và ở mục danh sách sách       | Nhập từ khóa "Công nghệ " vào ô Lọc theo thể loại                                                  | Từ khóa: "Công nghệ"                                     | (như trên)                                                                                                                      | REQ-03 | EP                |
