...
| TC-03-01     | Check search by book title using lowercase     | User or admin logged in and is at book list page                 | Enter the keyword "lập trình" into the search box (by book title or author).                       | Keyword: "lập trình"                                     | The system displays book titles: "Lập trình Flutter cơ bản" and "Nhập môn lập trình Python"                                     | REQ-03 | EP                |
| TC-03-02     | Check search by author name using lowercase    | User or admin logged in and is at book list page                 | Enter the keyword "vũ thị mai" into the search box (by book title or author).                      | Keyword: "vũ thị mai"                                    | The system displays the book title: "Nguyên lý kế toán" with the author "Vũ Thị Mai".                                           | REQ-03 | EP                |
| TC-03-03     | Check category filter using lowercase          | User or admin logged in and is at book list page                 | Enter the keyword "công nghệ" into the category filter box                                         | Keyword: "công nghệ"                                     | The system displays book titles belonging to the "Công nghệ" category.                                                          | REQ-03 | EP                |
| TC-03-04     | Check category filter using uppercase letters. | User or admin logged in and is at book list page                 | Enter the keyword "Công nghệ" into the category filter box                                         | Keyword: "Công nghệ"                                     | (same as above)                                                                                                                 | REQ-03 | EP                |
