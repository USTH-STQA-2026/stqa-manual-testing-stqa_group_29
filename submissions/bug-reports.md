...
System allows member to borrow a 4th book although the maximum limit is 3 books
...
According to REQ-05, if a book is returned after the due date, the system should display an overdue warning or overdue indication to inform users that the return was late.
...
System rejects valid email format when adding new member
